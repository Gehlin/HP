...
function AppInner() {
  ...
  useEffect(() => {
    // Shared cached loader: only its ids are needed here, so keep the
    // question bank out of the eager entry chunk (it's already pulled in,
    // via the same cached promise, by whichever lazy page the user visits).
