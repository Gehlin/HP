...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-50 pb-safe">
      <div className="mx-0 border-t border-[var(--color-card-border)] bg-[var(--color-paper)]">
        <div className="flex max-w-2xl mx-auto">
          {TABS.map(tab => {
            ...
            return (
              ...
              >
                {isActive && (
                  <span className="nav-pill absolute top-0 inset-x-4 h-[2px] rounded-full bg-[var(--color-green)]" />
                )}
