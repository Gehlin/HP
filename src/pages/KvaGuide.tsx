      ...
      <div className="max-w-lg mx-auto px-4 py-10 pb-24">
        ...
        <div className="card rounded-2xl p-4 mb-6 border border-[var(--color-card-border)]">
          ...
          <p className="text-sm text-[var(--color-ink-muted)] leading-relaxed">
            KVA handlar aldrig om att beräkna exakta svar — bara att avgöra <span className="text-[var(--color-terracotta)] font-semibold">vilken av två kvantiteter som är större</span>. Det räcker att bevisa att en är större, eller hitta ett motexempel för att välja D. Precision dödar tid; uppskattning vinner poäng.
          </p>
        </div>
              ...
              <div className="space-y-2 text-sm">
                {[
                  ...
                  <div key={q} className="flex items-center justify-between gap-4">
                    ...
                    <span className="text-[var(--color-terracotta)] font-black text-sm shrink-0">{a}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        {tab === 'strategi' && (
          <div className="space-y-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={time} className="flex gap-3 text-xs">
                    <span className="text-[var(--color-terracotta)] font-black shrink-0 w-12">{time}</span>
            ...
            <div className="card rounded-2xl p-4 border border-[var(--color-card-border)]">
              <div className="text-[10px] font-bold text-[var(--color-gold-deep)] uppercase tracking-widest mb-3">De vanligaste fällorna</div>
            ...
            {PATTERNS.map(p => (
              <div key={p.name} className={`rounded-2xl border ${p.border} ${p.bg} p-4`}>
                ...
                <div className="flex items-start gap-2">
                  <span className="text-[var(--color-terracotta)] text-[11px] shrink-0">→</span>
